...
public class OrderListPage extends BasePage implements MouseListener{
...
//		leftHeaderBox.setPreferredSize(new Dimension(200,25));
		...
		taoDonHang.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
		        RootFrame rootFrame = (RootFrame) SwingUtilities.getWindowAncestor(OrderListPage.this);
		        BasePage orderPage = rootFrame.getOrderPage();
		        Container container = getParent(); 
		        container.remove(OrderListPage.this); 
