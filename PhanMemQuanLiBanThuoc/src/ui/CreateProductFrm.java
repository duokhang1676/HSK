...
//		txt_maNhom.setSelectedIndex(0);
	...
	private void addRow() {
		...
		Thuoc t = new Thuoc( tenThuoc, nhaCC, donViTinh, thanhPhanChinh, donViTinhLe, hanSuDung, dkBaoQuan, donViTinhChan, ghiChu, giaNhapLe, giaNhapChan, giaBanLe, giaBanChan, nhomThuoc);
		try {
